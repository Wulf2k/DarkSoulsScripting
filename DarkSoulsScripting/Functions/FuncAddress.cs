...
namespace DarkSoulsScripting
{
    public enum FuncAddress : Int64
    {
        ...
        AddClearCount = 0x1404af090,
        AddCorpseEvent = 0x1404af830,
        AddCurrentVowRankPoint = 0x1404a9df0,
        AddCustomRoutePoint = 0x1404af010,
        AddDeathCount = 0x1404af7d0,
        AddEventGoal = 0x1404acd80,
        AddEventParts = 0x1404ae7d0,
        AddEventParts_Ignore = 0x1404ae800,
        AddEventSimpleTalk = 0x1404aeda0,
        AddEventSimpleTalkTimer = 0x1404aedd0,
        AddFieldInsFilter = 0x1404af910,
        AddGeneEvent = 0x1404afd40,
        AddHelpWhiteGhost = 0x1404ac110,
        AddHitMaskByBit = 0x1404aaff0,
        AddInfomationBuffer = 0x1404ada00,
        AddInfomationBufferTag = 0x1404ad930,
        AddInfomationList = 0x1404ad8e0,
        AddInfomationListItem = 0x1404ad910,
        AddInfomationTimeMsgTag = 0x1404ada50,
        AddInfomationTosBuffer = 0x1404adb00,
        AddInfomationTosBufferPlus = 0x1404adb30,
        AddInventoryItem = 0x1404abc90,
        AddKillBlackGhost = 0x1404ac120,
        AddQWC = 0x1404ac0b0,
        AddRumble = 0x1404b04c0,
        AddTreasureEvent = 0x1404af850,
        AddTrueDeathCount = 0x1404af7f0,
        BeginAction = 0x1404ab470,
        BeginLoopCheck = 0x1404ab7e0,
        CalcExcuteMultiBonus = 0x1404af230,
        CalcGetCurrentMapEntityId = 0x1404b0900,
        CalcGetMultiWallEntityId = 0x1404b0970,
        CamReset = 0x1404ab950,
        CastPointSpell = 0x1404ad4c0,
        CastPointSpell_Horming = 0x1404ad5b0,
        CastPointSpellPlus = 0x1404ad530,
        CastPointSpellPlus_Horming = 0x1404ad620,
        CastTargetSpell = 0x1404ad6a0,
        CastTargetSpellPlus = 0x1404ad6e0,
        ChangeGreyGhost = 0x1404ae0c0,
        ChangeInitPosAng = 0x1404ae5b0,
        ChangeModel = 0x1404ab3a0,
        ChangeTarget = 0x1404acce0,
        ChangeThink = 0x1404acca0,
        ChangeWander = 0x1404acfe0,
        CharacterAllAttachSys = 0x1404afaf0,
        CharactorCopyPosAng = 0x1404ab0f0,
        CheckChrHit_Obj = 0x1404acf40,
        CheckChrHit_Wall = 0x1404acf20,
        CheckEventBody = 0x1404ae830,
        CheckEventChr_Proxy = 0x1404acf60,
        CheckPenalty = 0x1404b05e0,
        ChrDisableUpdate = 0x1404ac670,
        ChrFadeIn = 0x1404afd80,
        ChrFadeOut = 0x1404afda0,
        ChrResetAnimation = 0x1404b0000,
        ChrResetRequest = 0x1404affc0,
        ClearBossGauge = 0x1404afe70,
        ClearMyWorldState = 0x1404b0ba0,
        ClearRecallData = 0x1404afad0,
        ClearSosSign = 0x1404af4c0,
        ClearTarget = 0x1404acd00,
        CloseGenDialog = 0x1404af430,
        CloseMenu = 0x1404abc00,
        CloseRankingDialog = 0x1404af450,
        CloseTalk = 0x1404aed80,
        CompleteEvent = 0x1404a6e70,
        CreateCamSfx = 0x1404ad740,
        CreateDamage_NoCollision = 0x1404b04a0,
        CreateEventBody = 0x1404AE5D0,
        CreateEventBodyPlus = 0x1404AE6A0,
        CreateHeroBloodStain = 0x1404b0b20,
        CreateSfx = 0x1404ad700,
        CreateSfx_DummyPoly = 0x1404ad720,
        CroseBriefingMsg = 0x1404aff40,
        CustomLuaCall = 0x1404AAA40,
        CustomLuaCallStart = 0x1404AAA90,
        CustomLuaCallStartPlus = 0x1404AAAC0,
        DeleteCamSfx = 0x1404AD760,
        DeleteEvent = 0x1404AB400,
        DeleteObjSfxAll = 0x1404AE3D0,
        DeleteObjSfxDmyPlyID = 0x1404AE390,
        DeleteObjSfxEventID = 0x1404AE3B0,
        DisableCollection = 0x1404AF6D0,
        DisableDamage = 0x1404ae2b0,
        DisableHpGauge = 0x1404AF6F0,
        DisableInterupt = 0x1404ACDE0,
        DisableMapHit = 0x1404abab0,
        DisableMove = 0x1404aba80,
        DivideRest = 0x1404B8D70,
        EnableAction = 0x1404AB380,
        EnableGeneratorSystem = 0x1404aeff0,
        EnableHide = 0x1404ae290,
        EnableInvincible = 0x1404AE2D0,
        EnableLogic = 0x1404ab350,
        EnableObjTreasure = 0x1404AECD0,
        EndAnimation = 0x1404AA8D0,
        EraseEventSpecialEffect = 0x1404ace40,
        EraseEventSpecialEffect_2 = 0x1404ACEA0,
        EventTagInsertString_forPlayerNo = 0x1404ADC70,
        ExcutePenalty = 0x1404AF210,
        ForceChangeTarget = 0xD61E00,
        ForceDead = 0x1404ad3c0,
        ForcePlayAnimation = 0x1404aa750,
        ForcePlayAnimationStayCancel = 0x1404aa7f0,
        ForcePlayLoopAnimation = 0x1404aa860,
        ForceSetOmissionLevel = 0x1404ae990,
        ForceUpdateNextFrame = 0xD60C90,
        GetBountyRankPoint = 0xD60130,
        GetClearBonus = 0x1404af500,
        GetClearCount = 0x1404af070,
        GetClearState = 0x1404af0b0,
        GetCurrentMapAreaNo = 0x1404ae1a0,
        GetCurrentMapBlockNo = 0x1404ae1c0,
        GetDeathState = 0x1404b0a00,
        GetDistance = 0x1404abde0,
        GetEnemyPlayerId_Random = 0xD5ED10,
        GetEventFlagValue = 0x1404b08c0,
        GetEventGoalState = 0xD612F0,
        GetEventMode = 0xD61690,
        GetEventRequest = 0xD610D0,
        GetFloorMaterial = 0xFF04A97E0,
        GetGlobalQWC = 0x1404ac090,
        GetHeroPoint = 0xD5DC50,
        GetHostPlayerNo = 0x1404aa3d0,
        GetHp = 0x1404abe50,
        GetHpRate = 0xD5FA30,
        GetItem = 0xD5E240,
        GetLadderCount = 0xD64580,
        GetLastBlockId = 0x1404ae1e0,
        GetLocalPlayerChrType = 0x1404ab870,
        GetLocalPlayerId = 0x1404aa3b0,
        GetLocalPlayerInvadeType = 0x1404ab8b0,
        GetLocalPlayerSoulLv = 0x1404b01f0,
        GetLocalPlayerVowType = 0x1404ab8f0,
        GetLocalQWC = 0x1404ac070,
        GetMultiWallNum = 0xD5DC40,
        GetMyBloodBlockId = 0x1404ae230,
        ...
        IsJobType = 0xD5E040,
        IsLand = 0xD60450,
        IsLiveNetPlayer = 0x1404ad090,
        IsLivePlayer = 0x1404ad040,
        IsLoadWait = 0x1404af740,
        IsMatchingMultiPlay = 0xD5ED80,
        IsOnline = 0x1404a7140,
        IsOnlineMode = 0x1404b01e0,
        IsPlayerAssessMenu_Tutorial = 0x1404ae400,
        ...
        IsReviveWait = 0xff04aea30,
        IsShow_CampMenu = 0xFF04A77E0,
        IsShowMenu = 0xFF04A4E80,
        ...
        OpenCampMenu = 0x1404ae340,
        OpeningDead = 0xD66600,
        OpeningDeadPlus = 0xD665D0,
        OpenSOSMsg_Tutorial = 0x1404ae410,
        ParamInitialize = 0xD66360,
        PauseTutorial = 0x1404ade00,
        PlayAnimation = 0x1404aa710,
        PlayAnimationStayCancel = 0x1404aa7b0,
        PlayerChrResetAnimation_RemoOnly = 0xD60630,
        PlayLoopAnimation = 0x1404aa820,
        PlayObjectSE = 0x1404abc10,
        PlayPointSE = 0x1404abc50,
        PlayTypeSE = 0x1404abc30,
        RecallMenuEvent = 0xD62780,
        ReconstructBreak = 0xD66070,
        RecoveryHeroin = 0xD60740,
        RecvGlobalQwc = 0x1404b0500,
        RegistObjact = 0xD5D870,
        RegistSimpleTalk = 0xD628A0,
        RemoveInventoryEquip = 0x1404aeb30,
        ...
        ReqularLeavePlayer = 0x1404b0280,
        ...
        ReturnMapSelect = 0x1404ab930,
        RevivePlayer = 0x1404adf60,
        RevivePlayerNext = 0x1404adf80,
        SaveRequest = 0x1404afe80,
        SaveRequest_Profile = 0x1404afea0,
        SendEventRequest = 0xD61130,
        SetAlive = 0xD664A0,
        SetAliveMotion = 0x1404ae9d0,
        ...
        SetEventFlag = 0x1405b1380,
        SetEventFlagValue = 0x1404b0880,
        SetEventGenerate = 0xD604B0,
        SetEventMovePointType = 0x1404af050,
        SetEventSimpleTalk = 0xD64BD0,
        SetEventSpecialEffect = 0x1404ace00,
        SetEventSpecialEffect_2 = 0x1404ace60,
        SetEventSpecialEffectOwner = 0xD61240,
        SetEventSpecialEffectOwner_2 = 0x1404ace80,
        SetEventTarget = 0xD61AA0,
        SetExVelocity = 0xD61F30,
        SetFirstSpeed = 0x1404aca90,
        SetFirstSpeedPlus = 0x1404acae0,
        SetFlagInitState = 0xD5DBF0,
        SetFootIKInterpolateType = 0x1404b0a60,
        SetForceJoinBlackRequest = 0xD65DF0,
        SetHitInfo = 0xD61990,
        SetHitMask = 0xD64920,
        SetHp = 0x1404abee0,
        SetIgnoreHit = 0x1404ae570,
        SetInfomationPriority = 0x1404adb60,
        SetInsideBattleArea = 0xD61050,
        SetIsAnimPauseOnRemoPlayForEvent = 0xD5F300,
        SetKeepCommandIndex = 0xD624F0,
        //SetLeaveSoulSteel = Nullsubbed
        SetLoadWait = 0xD5D940,
        SetLockActPntInvalidateMask = 0xD608F0,
        SetMapUid = 0x1404ade20,
        SetMaxHp = 0x1404abfa0,
        SetMenuBrake = 0x1404abbf0,
        SetMiniBlockIndex = 0x1404ae890,
        SetMovePoint = 0x1404acd20,
        ...
        SetObjSfx = 0x1404ae350,
        SetReturnPointEntityId = 0xD5DC70,
        SetReviveWait = 0x1404aea10,
        SetSelfBloodMapUid = 0xD5FFF0,
        SetSosSignPos = 0x1404ae8e0,
        SetSosSignWarp = 0x1404ae090,
        SetSpStayAndDamageAnimId = 0xD609C0,
        SetSpStayAndDamageAnimIdPlus = 0xD60980,
        SetSubMenuBrake = 0x1404b0480,
        SetSummonedPos = 0x1404ae050,
        SetSyncRideObjInfo = 0xD60520,
        SetSystemIgnore = 0x1404b0210,
        SetTalkMsg = 0x1404ac750,
        SetTeamType = 0xD60B50,
        SetTeamTypeDefault = 0xD60B00,
        SetTeamTypePlus = 0xD60B30,
        SetTextEffect = 0x1404af9d0,
        SetTutorialSummonedPos = 0x1404ae070,
        SetValidTalk = 0x1404aee10,
        ShowGenDialog = 0x1404af3e0,
        ShowRankingDialog = 0x1404af440,
        ...
        TurnCharactor = 0x1404ac150,
        Tutorial_begin = 0x1404ae0a0,
        Tutorial_end = 0x1404ae0b0,
        UnLockSession = 0x1404aff80,
        ...
        ValidPointLight = 0x1404acb60,
        ValidSfx = 0x1404acb20,
        ...
        Warp = 0x1404aa3f0,
        WarpDmy = 0x1404aa420,
        WarpNextStage = 0x1404aa4c0,
        WarpNextStage_Bonfire = 0x1404aa520,
        WarpNextStageKick = 0x1404adfa0,
        WarpRestart = 0x1404aa450,
        WarpRestartNoGrey = 0x1404aa470,
        WarpSelfBloodMark = 0x1404aa5b0
    }
