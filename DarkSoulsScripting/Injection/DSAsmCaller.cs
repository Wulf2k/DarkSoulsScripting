    ...
    dynamic rdi = null)
        {
            ...
            byte[] asm64 = {
                0x9C, //pushfq
                0x48, 0x81, 0xEC, 0x80, 0x00, 0x00, 0x00, //add rsp, 00000080
                ...
                0x48, 0xBB, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, //mov val return address to rbx (86d)
                0x48, 0x89, 0x03, //mov [rbx], rax

                0x48, 0x81, 0xC4, 0x80, 0x00, 0x00, 0x00, //sub rsp, 00000080
                0x9D,  //popfq
                0xC3    //retn
            };
